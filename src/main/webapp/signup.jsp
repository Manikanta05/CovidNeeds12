          ...
          <div class="card2 card border-0 px-4 py-5 ">
              <form action="${pageContext.request.contextPath}/operation" method="POST">
			              <div class="row px-3"> <label class="mb-1">
			                ...
			                </label> <input class="mb-4" type="password" name="password" placeholder="Enter password" required> </div>
			                   <label class="mb-1"><h6 class="mb-0 text-sm">Type</h6>        
			                   <input type="radio"  id="user" name="type" value="user">
			                   <label for="user">User</label><br>
			                   <input type="radio" id="org" name="type" value="org">
			                   <label for="org">Organisation</label>
			               </div>
							<input type="hidden" name="form" value="addUserOperation">
			              
			  
			              <div class="row px-3"> <button type="submit" class="btn btn-info text-center" style="max-width: 150px;"><a href="#"></a>Sign Up</a></button> </div>
			         <p class="text-muted">Already have an account ? Login            
			  <a class="text-primary" href="${pageContext.request.contextPath}/operation?page=login">Here</a></p>
		</form>
        </div>            
        </div>
        </div>
